    ...
    switch ($request->getPost("action")) {
        ...
        case "save_profile":
            ...
            if (empty($request->getPost("name"))) {
                echo json_encode(["success" => true, "message" => Loc::getMessage("DDAPP_IMAGES_MESSAGE_PROFILE_NAME_ERROR")]);
                exit;
            }
            ...
            if (!empty($request->getPost("profile_id"))) {
                ...
                echo json_encode(["success" => true, "message" => Loc::getMessage("DDAPP_IMAGES_MESSAGE_PROFILE_ADD")]);
            } else {
                $result = DataImages::add($fields);
                echo json_encode(["success" => true, "message" => Loc::getMessage("DDAPP_IMAGES_MESSAGE_PROFILE_EDIT"), "id" => $result->getId()]);
            }
            exit;
        ...
        case "delete_profile":
            if (!empty($request->getPost("profile_id"))) {
                ...
                echo json_encode(["success" => true, "message" => Loc::getMessage("DDAPP_IMAGES_MESSAGE_PROFILE_DELETE")]);
            }
            exit;
