...
class DDAppFormButtonComponent extends CBitrixComponent
{
    ...
    public function executeComponent(): void
    {
        ...
        // Формируем уникальные ID для элементов
        $buttonId = "ddapp_form_button_" . $this->iblockId;
        $modalId = "ddapp_form_modal_" . $this->iblockId;

        // Передаем данные в результат
        $this->arResult["IBLOCK_ID"] = $this->iblockId;
        $this->arResult["IBLOCK_NAME"] = $arIblock["NAME"];
        $this->arResult["BUTTON_ID"] = $buttonId;
        $this->arResult["MODAL_ID"] = $modalId;
    ...
    private function prepareFormParams(): array
    {
        return [
            ...
            "BUTTON_ID" => $this->arResult["MODAL_ID"],
            "MODAL_ID" => $this->arResult["MODAL_ID"],
            ...
            "AJAX_MODE" => "Y" // Специальный флаг для AJAX режима
        ];
    }
