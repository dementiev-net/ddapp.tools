...
BX.DDAPP.Tools.ImagesManager.prototype = {
    ...
    initElements: function () {
        ...
        if (!this.exportButton) {
            console.warn('ImagesManager: Export button not found');
            return false;
        }
    ...
    onExportComplete: function () {
        console.log('ImagesManager: Export completed. Exported:', this.exported, 'Total:', this.total, 'Errors:', this.errorsCount);
    },
